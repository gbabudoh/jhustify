          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card hover>
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-[#6d6e6b] mb-2">Verification Process</h3>
            ...
            <Card hover>
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-[#6d6e6b] mb-2">Customer Confidence</h3>
                <p className="text-gray-600">
            ...
            <Card hover>
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-[#6d6e6b] mb-2">Fraud Prevention</h3>
                <p className="text-gray-600">
            ...
            <Card hover>
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-[#6d6e6b] mb-2">Full Transparency</h3>
                <p className="text-gray-600">
            ...
            <Card hover>
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-[#6d6e6b] mb-2">Trust Badges</h3>
                <p className="text-gray-600">
            ...
            <Card hover>
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-[#6d6e6b] mb-2">Secure Transactions</h3>
                <p className="text-gray-600">
